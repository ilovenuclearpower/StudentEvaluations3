...
namespace Student_Evaluation_3.Migrations
{
    ...
    [Migration("20190508002227_azureistheworstthingthateverhappenedtosoftwaredevelopment")]
    partial class azureistheworstthingthateverhappenedtosoftwaredevelopment
    {
            ...
            modelBuilder.Entity("Student_Evaluation_3.Models.Evaluation", b =>
                {
                    ...
                    b.HasOne("Student_Evaluation_3.Models.Stakeholder", "Stakeholder")
                        .WithMany()
                        .HasForeignKey("StakeHolderID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
